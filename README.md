...
```text
packages\sp-plugin\release\SPPet-SP-v0.3.3.zip
```
...
解压 `SPPet-v0.3.3-win-x64.zip`，运行 `SPPet.exe`。桌宠默认只显示角色：
...
- 火克冰、冰克电、电克水、水克火：克制为 `×1.50`，被克为 `×0.75`；同属性元素护盾为 `×0.65`。物理固定为 `×1.00`，不参与元素交互。

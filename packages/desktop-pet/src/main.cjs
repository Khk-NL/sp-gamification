...
const createTrayIcon = () => { const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"><path d="M4 5h24v20l-6 6H4z" fill="#111417"/><path d="M8 9h16v12H8z" fill="#f1f1ec"/><path d="M19 9h5v5z" fill="#fed403"/></svg>`; return nativeImage.createFromDataURL(`data:image/svg+xml;base64,${Buffer.from(svg).toString('base64')}`); };

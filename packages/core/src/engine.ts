...
export const getComputedStats = (stateInput: SPPetState, contentInput?: GameContent): CombatStats => {
  ...
  if ((setCounts.get('frostline') ?? 0) >= 2) { stats.resistances.ice += 15; stats.damageBonus.ice = (stats.damageBonus.ice ?? 0) + 15; }

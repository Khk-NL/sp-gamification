...
export const DEFAULT_CONTENT: GameContent = {
  ...
  skills: [
    ...
    { id: 'brace', name: '防御姿态', nameEn: 'Brace', description: '获得护盾并造成少量伤害。', cost: 1, type: 'physical', power: 0.35, block: 10 },
    { id: 'ember-shot', name: '灼流弹', nameEn: 'Ember Shot', description: '火焰伤害并附加灼烧。', cost: 2, type: 'fire', power: 0.9, burn: 4 },
    { id: 'tide-cut', name: '潮切', nameEn: 'Tide Cut', description: '高倍率水属性攻击。', cost: 2, type: 'water', power: 1.25 },
    { id: 'frost-ward', name: '霜盾', nameEn: 'Frost Ward', description: '冰属性伤害、护盾并削弱敌方下次攻击。', cost: 2, type: 'ice', power: 0.65, block: 8, weaken: 20 },
    { id: 'arc-burst', name: '弧光过载', nameEn: 'Arc Burst', description: '强力电属性攻击。', cost: 3, type: 'electric', power: 1.65 },
  ],
  items: [
    ...
    { id: 'frost-plate', kind: 'armor', name: '霜线护甲', nameEn: 'Frostline Plate', description: '防御 +5，冰抗 +20%。', price: 112, icon: 'ARM', slot: 'armor', setId: 'frostline', effects: { defense: 5, resistance: { ice: 20 } } },
    { id: 'relay-module', kind: 'accessory', name: '中继模组', nameEn: 'Relay Module', description: '生命 +10，全抗 +5%。', price: 88, icon: 'ACC', slot: 'accessory', effects: { maxHp: 10, resistance: { physical: 5, fire: 5, water: 5, ice: 5, electric: 5 } } },
  ...
  chapters: [
    { id: 'waste-relay', name: '第一章：废墟中继站', nameEn: 'CH.1 Wasteland Relay', summary: '清理失控设施并夺回中继节点。', enemies: [
      { id: 'scrap-drone', name: '废件巡游机', nameEn: 'Scrap Drone', maxHp: 52, attack: 9, defense: 1, resistances: resist({ electric: -15, physical: 10 }), intents: [{ kind: 'attack', value: 8, type: 'physical', label: '切割 8', labelEn: 'Slash 8' }, { kind: 'guard', value: 7, label: '装甲 7', labelEn: 'Guard 7' }, { kind: 'attack', value: 11, type: 'electric', label: '放电 11', labelEn: 'Shock 11' }], xp: 24, coins: 12 },
      { id: 'crystal-hound', name: '结晶猎犬', nameEn: 'Crystal Hound', maxHp: 76, attack: 11, defense: 2, resistances: resist({ ice: 25, fire: -20 }), intents: [{ kind: 'buff', value: 2, label: '蓄势 +2 攻', labelEn: 'Sharpen +2 ATK' }, { kind: 'attack', value: 13, type: 'ice', label: '冰咬 13', labelEn: 'Frost Bite 13' }, { kind: 'attack', value: 8, type: 'physical', label: '连扑 8', labelEn: 'Pounce 8' }], xp: 34, coins: 18 },
      { id: 'relay-overseer', name: '中继监管者', nameEn: 'Relay Overseer', maxHp: 128, attack: 14, defense: 4, resistances: resist({ physical: 15, water: -15 }), intents: [{ kind: 'guard', value: 12, label: '力场 12', labelEn: 'Barrier 12' }, { kind: 'attack', value: 14, type: 'fire', label: '热线 14', labelEn: 'Heat Ray 14' }, { kind: 'buff', value: 3, label: '超频 +3 攻', labelEn: 'Overclock +3 ATK' }, { kind: 'attack', value: 20, type: 'electric', label: '过载 20', labelEn: 'Overload 20' }], xp: 62, coins: 38, isBoss: true },
    ] },
    { id: 'frozen-quarry', name: '第二章：冻结采掘区', nameEn: 'CH.2 Frozen Quarry', summary: '穿越低温矿坑，处理异常核心。', enemies: [
      { id: 'mist-caster', name: '雾流术体', nameEn: 'Mist Caster', maxHp: 92, attack: 14, defense: 3, resistances: resist({ water: 25, electric: -15 }), intents: [{ kind: 'attack', value: 12, type: 'water', label: '潮涌 12', labelEn: 'Surge 12' }, { kind: 'guard', value: 9, label: '水幕 9', labelEn: 'Veil 9' }, { kind: 'attack', value: 17, type: 'ice', label: '凝结 17', labelEn: 'Freeze 17' }], xp: 46, coins: 24 },
      { id: 'furnace-shell', name: '熔炉重壳', nameEn: 'Furnace Shell', maxHp: 145, attack: 16, defense: 7, resistances: resist({ fire: 40, water: -25 }), intents: [{ kind: 'guard', value: 15, label: '闭壳 15', labelEn: 'Shell 15' }, { kind: 'attack', value: 18, type: 'fire', label: '喷焰 18', labelEn: 'Flame 18' }, { kind: 'attack', value: 10, type: 'physical', label: '碾压 10', labelEn: 'Crush 10' }], xp: 58, coins: 31 },
      { id: 'quarry-heart', name: '采掘区心脏', nameEn: 'Quarry Heart', maxHp: 210, attack: 19, defense: 6, resistances: resist({ ice: 30, fire: -10, electric: -10 }), intents: [{ kind: 'buff', value: 4, label: '升压 +4 攻', labelEn: 'Pressure +4 ATK' }, { kind: 'attack', value: 16, type: 'ice', label: '寒潮 16', labelEn: 'Cold Wave 16' }, { kind: 'guard', value: 18, label: '结晶壁 18', labelEn: 'Crystal Wall 18' }, { kind: 'attack', value: 25, type: 'physical', label: '坍塌 25', labelEn: 'Collapse 25' }], xp: 92, coins: 55, isBoss: true },
    ] },
  ],
};
...
export const normalizeContent = (input: unknown): GameContent => {
  ...
  const chapters = value.chapters.filter((chapter) => chapter && Array.isArray(chapter.enemies) && chapter.enemies.length).map((chapter) => ({ ...chapter, enemies: chapter.enemies.map((enemy) => ({ ...enemy, resistances: { ...ZERO_RESISTANCE, ...(enemy.resistances ?? {}) }, intents: Array.isArray(enemy.intents) && enemy.intents.length ? enemy.intents.filter((intent) => intent && ['attack', 'guard', 'buff'].includes(intent.kind) && (!intent.type || damageTypes.includes(intent.type))) : [{ kind: 'attack' as const, value: 5, type: 'physical' as const, label: '攻击 5', labelEn: 'Attack 5' }] })) }));
